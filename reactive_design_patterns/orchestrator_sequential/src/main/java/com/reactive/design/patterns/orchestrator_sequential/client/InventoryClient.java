package com.reactive.design.patterns.orchestrator_sequential.client;


import com.reactive.design.patterns.orchestrator_sequential.dto.InventoryRequest;
import com.reactive.design.patterns.orchestrator_sequential.dto.InventoryResponse;
...
public class InventoryClient {
    ...
    public InventoryClient(@Value("${orchestrator.sequential.inventory.service}") String baseUrl){
