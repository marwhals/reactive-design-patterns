...
import com.reactive.design.patterns.orchestrator_parallel.dto.ShippingResponse;
...
public class ShippingClient {
    ...
    public ShippingClient(@Value("${orchestrator.parallel.shipping.service}") String baseUrl){
