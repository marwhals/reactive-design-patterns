package com.reactive.design.patterns.orchestrator_parallel.client;

import com.reactive.design.patterns.orchestrator_parallel.dto.InventoryRequest;
import com.reactive.design.patterns.orchestrator_parallel.dto.InventoryResponse;
...
public class InventoryClient {
    ...
    public InventoryClient(@Value("${orchestrator.parallel.inventory.service}") String baseUrl){
