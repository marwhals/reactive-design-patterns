...
import com.reactive.design.patterns.orchestrator_parallel.dto.PaymentResponse;
...
public class UserClient {
    ...
    public UserClient(@Value("${orchestrator.parallel.user.service}") String baseUrl){
